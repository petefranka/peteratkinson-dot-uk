export const siteUrl =
  process.env.NEXT_PUBLIC_SITE_URL ?? 'https://www.peteratkinson.co.uk';

export const siteName = 'Peter Atkinson';
export const siteTitle = 'Peter Atkinson - Senior Engineer';
